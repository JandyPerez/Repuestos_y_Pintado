...
public class Empleado {
    private final StringProperty id_empleado;
    ...
    public Empleado(String id, String nombre, String puesto, String telefono) {
        this.id_empleado = new SimpleStringProperty(id);
        this.nombre_completo = new SimpleStringProperty(nombre);
        this.puesto = new SimpleStringProperty(puesto);
        this.telefono = new SimpleStringProperty(telefono);
    }

    public String getId() { return id_empleado.get(); }
    public String getNombre() { return nombre_completo.get(); }
    public String getPuesto() { return puesto.get(); }
    public String getTelefono() { return telefono.get(); }

    public StringProperty idProperty() { return id_empleado; }
